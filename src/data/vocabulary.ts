...
export const weeklyList: VocabularyList = {
  ...
  entries: [
    ...
    { simplified: "文", traditional: "文" },
    { simplified: "美", traditional: "美" },
    { simplified: "中", traditional: "中" },
    { simplified: "小", traditional: "小" },
    { simplified: "要", traditional: "要" },
    { simplified: "过", traditional: "過" },
    { simplified: "国", traditional: "國" },
    { simplified: "大", traditional: "大" },
    { simplified: "不", traditional: "不" },
    { simplified: "上", traditional: "上" }
  ],
};
